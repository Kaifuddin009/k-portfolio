  ...
  return (
    ...
    className={`flex w-full flex-col-reverse items-center gap-8 ${align == 'left' ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
        <div>
            ...
            <a href={link} target ="_blank" className={`text-lg flex gap-2 items-center dark:hover:text-black transition-all duration-500 cursor-pointer  sm:justify-self-center ${align === 'left' ? 'md:justify-self-end' : 'md:justify-self-start'} `}>{t('view')}<BiSolidRightTopArrowCircle /></a>
        </div>
