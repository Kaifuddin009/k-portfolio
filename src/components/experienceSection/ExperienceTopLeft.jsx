...
const ExperienceTopLeft = () => {
  ...
  return (
    <div className='flex flex-col gap-6 w-[300px]'>
        <p className='font-bold uppercase text-3xl font-sans text-center'>{t("SINCE")} 2024</p>
        <div className='flex justify-center items-center gap-7'>
            <ExperienceInfo number="1.5+" text={t("YEARS")}/>
            <p className='font-bold text-6xl'>-</p>
            <ExperienceInfo number="2" text={t("PORTFOLIO")}/>
        </div>
