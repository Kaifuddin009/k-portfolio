...
const HeroText = () => {
  return (
    <div className='flex flex-col gap-4  h-full justify-center items-center text-center md:items-start  md:text-left sm:text-center ' >
        ...
        className='lg:text-2xl sm:text-xl lg:-3xl uppercase'>Front-End Development
        </motion.h2>
        <motion.h1 
        ...
        <motion.p 
          ...
          whileInView="show"
          viewport={{once: false, amount: 0}}
        className='text-2xl sm:text-2xl m-6 w-full'>A passionate software developer <br/>& web developer </motion.p>
    </div>
  )
}
